...
%     
%
% This code performs three different methodologies, Hysteresis, Otsu, and
% simple thresholding methods to separate GPS uncertainty signal into two
%                  main parts: INDOORs and 'OUTDOORs'.
%
%--------------------------------------------------------------------------
...
% If the first peak of density occures between 5m and 20m, then we probably have
% outdoor samples in the signal, otherwise it is only indoor signal.
...
if p2(1)<20 && p2(1)> 5 % if the first peak of density signal is between 5 and 20m
