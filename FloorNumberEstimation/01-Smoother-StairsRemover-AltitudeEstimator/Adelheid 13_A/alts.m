...
% Alts: gives you all altitude values of floors of 
% each dataset
...
%   Copyright 2017 OMID REZA MOSLEHI RAD 
...
for a=1:length(file_names)
  ...
  for g = 1:K
    ...
    ClusterCentroids_Agness_33{a} = ((power(Ref_pressure_current_file./C,1/5.257)-1)*(temps(a)+273.15))/0.0065;
end % end of main for loop
figure
plot(distortions_Adel_13{1,1},'b*--')
title('Agness33 elbow')
hold on
