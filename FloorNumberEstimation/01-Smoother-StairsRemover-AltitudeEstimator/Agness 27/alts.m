...
for a=1:length(file_names)
  ...
  % Smooth raw data
  smoothed = medfilt1(cell2mat(my_data(a)),10);
  ...
  count=count+1;
  ClusterCentroids_Agness_27{a} = ((power(Ref_pressure_current_file./C,1/5.257)-1)*(temps(a)+273.15))/0.0065;
end % end of main for loop


figure
plot(distortions{1,1},'b*--')
title('Agness27 elbow')
hold on
